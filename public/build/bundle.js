...
var app = (function () {
    ...
    /* src/components/AddTodo.svelte generated by Svelte v3.37.0 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 28, 4, 653);
    			add_location(form, file$3, 27, 0, 607);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*todo*/ ctx[0].texto);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*todo*/ 1 && input.value !== /*todo*/ ctx[0].texto) {
    				set_input_value(input, /*todo*/ ctx[0].texto);
    			}
    		},
    		i: noop$1,
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const addTodo = () => {
    		if (!todo.texto.trim()) {
    			...
    			$$invalidate(0, todo.texto = "", todo);
    			return;
    		}

    		$$invalidate(0, todo.id = Date.now(), todo);
    		todos.add(todo);
    		console.log($todos);
    		$$invalidate(0, todo = { id: "", texto: "", estado: false });
    	...
    	$$self.$capture_state = () => ({ todos, opc, todo, addTodo, $todos });
    	...
    	return [todo, addTodo, input_input_handler];
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", p_class_value = /*item*/ ctx[0].estado
    			? "text-decoration-line-through"
    			: "");

    			add_location(p, file$2, 32, 4, 810);
    			attr_dev(i0, "class", i0_class_value = /*classIcono*/ ctx[3](/*item*/ ctx[0].estado));
    			add_location(i0, file$2, 40, 8, 1020);
    			attr_dev(button0, "class", button0_class_value = "btn btn-sm " + /*classEstado*/ ctx[4](/*item*/ ctx[0].estado));
    			add_location(button0, file$2, 36, 4, 907);
    			attr_dev(i1, "class", "bi bi-trash");
    			add_location(i1, file$2, 44, 8, 1152);
    			attr_dev(button1, "class", "btn btn-sm btn-danger");
    			add_location(button1, file$2, 43, 4, 1077);
    			attr_dev(div, "class", "shadow my-3 p-3 lead");
    			add_location(div, file$2, 31, 0, 771);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(/*editTodo*/ ctx[2](/*item*/ ctx[0].id))) /*editTodo*/ ctx[2](/*item*/ ctx[0].id).apply(this, arguments);
    						},
    						false,
    						false,
    						false
    					...
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(/*delTodo*/ ctx[1](/*item*/ ctx[0].id))) /*delTodo*/ ctx[1](/*item*/ ctx[0].id).apply(this, arguments);
    						},
    						false,
    						false,
    						false
    		...
    		p: function update(new_ctx, [dirty]) {
    			ctx = new_ctx;
    			if (dirty & /*item*/ 1 && t0_value !== (t0_value = /*item*/ ctx[0].texto + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*item*/ 1 && p_class_value !== (p_class_value = /*item*/ ctx[0].estado
    			? "text-decoration-line-through"
    			: "")) {
    				attr_dev(p, "class", p_class_value);
    			}

    			if (dirty & /*item*/ 1 && i0_class_value !== (i0_class_value = /*classIcono*/ ctx[3](/*item*/ ctx[0].estado))) {
    				attr_dev(i0, "class", i0_class_value);
    			}

    			if (dirty & /*item*/ 1 && button0_class_value !== (button0_class_value = "btn btn-sm " + /*classEstado*/ ctx[4](/*item*/ ctx[0].estado))) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [item, delTodo, editTodo, classIcono, classEstado];
    }
    ...
    class Todo extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*item*/ ctx[0] === undefined && !("item" in props)) {
    			console_1.warn("<Todo> was created without expected prop 'item'");
    		}
    	}
    ...
    */
    ...
    /* src/components/Toast.svelte generated by Svelte v3.37.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$opc*/ 2 && t0_value !== (t0_value = /*$opc*/ ctx[1].texto + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*$opc*/ 2 && div2_class_value !== (div2_class_value = "toast align-items-center text-white " + /*$opc*/ ctx[1].color + " border-0")) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let $opc;
    	validate_store(opc, "opc");
    	component_subscribe($$self, opc, $$value => $$invalidate(1, $opc = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$capture_state = () => ({ Toast, opc, toastEl, instancia, $opc });

    	$$self.$inject_state = $$props => {
    		if ("toastEl" in $$props) $$invalidate(0, toastEl = $$props.toastEl);
    		if ("instancia" in $$props) $$invalidate(2, instancia = $$props.instancia);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*toastEl*/ 1) {
    			if (toastEl) {
    				$$invalidate(2, instancia = new Toast(toastEl));
    			}
    		}

    		if ($$self.$$.dirty & /*$opc, instancia*/ 6) {
    			if ($opc.estado) {
    				instancia.show();
    			}
    		}
    	...
    	return [toastEl, $opc, instancia, div2_binding];
    }
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const todo_changes = {};
    			if (dirty & /*$todos*/ 1) todo_changes.item = /*item*/ ctx[1];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(20:2) {#each $todos as item}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "display-5 my-3");
    			add_location(h1, file, 17, 2, 417);
    			attr_dev(div, "class", "container");
    			add_location(div, file, 16, 0, 391);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div, h1);
    			append_dev(div, t1);
    			mount_component(addtodo, div, null);
    			append_dev(div, t2);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ todos, AddTodo, Todo, Toast: Toast_1, $todos });
